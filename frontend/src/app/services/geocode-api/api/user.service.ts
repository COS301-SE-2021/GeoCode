...
import { HandleLoginRequest } from '../model/handleLoginRequest';
import { HandleLoginResponse } from '../model/handleLoginResponse';
...
export class UserService {
     ...
     * Handles login of Users
     * @param body Handles login of Users
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public handleLogin(body: HandleLoginRequest, observe?: 'body', reportProgress?: boolean): Observable<HandleLoginResponse>;
    public handleLogin(body: HandleLoginRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<HandleLoginResponse>>;
    public handleLogin(body: HandleLoginRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<HandleLoginResponse>>;
    public handleLogin(body: HandleLoginRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling handleLogin.');
        }
        ...
        return this.httpClient.request<HandleLoginResponse>('post',`${this.basePath}/User/handleLogin`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
