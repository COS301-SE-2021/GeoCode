...
export class UserService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public handleLogin(body: HandleLoginRequest, observe?: 'body', reportProgress?: boolean): Observable<Response>;
    public handleLogin(body: HandleLoginRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Response>>;
    public handleLogin(body: HandleLoginRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Response>>;
    public handleLogin(body: HandleLoginRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Response>('post',`${this.basePath}/User/handleLogin`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
