...
import { UploadImageResponse } from '../model/uploadImageResponse';
...
export class ImageService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public uploadImage(body?: Object, observe?: 'body', reportProgress?: boolean): Observable<UploadImageResponse>;
    public uploadImage(body?: Object, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<UploadImageResponse>>;
    public uploadImage(body?: Object, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<UploadImageResponse>>;
    public uploadImage(body?: Object, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<UploadImageResponse>('post',`${this.basePath}/Image/uploadImage`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
