...
import { GetCurrentEventLevelRequest } from '../model/getCurrentEventLevelRequest';
import { GetCurrentEventLevelResponse } from '../model/getCurrentEventLevelResponse';
import { GetCurrentEventRequest } from '../model/getCurrentEventRequest';
import { GetCurrentEventResponse } from '../model/getCurrentEventResponse';
...
export class EventService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCurrentEvent(body: GetCurrentEventRequest, observe?: 'body', reportProgress?: boolean): Observable<GetCurrentEventResponse>;
    public getCurrentEvent(body: GetCurrentEventRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GetCurrentEventResponse>>;
    public getCurrentEvent(body: GetCurrentEventRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GetCurrentEventResponse>>;
    public getCurrentEvent(body: GetCurrentEventRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<GetCurrentEventResponse>('post',`${this.basePath}/Event/getCurrentEvent`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    /**
     * Retrieves a specific stored GeoCode to complete a Level for an Event that a user is involved in
     * Get a stored GeoCode to complete a Level for an Event in the system with the specified id that a user is busy with
     * @param body Request to get a specified GeoCode to complete a Level for an Event a user is busy with
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getCurrentEventLevel(body: GetCurrentEventLevelRequest, observe?: 'body', reportProgress?: boolean): Observable<GetCurrentEventLevelResponse>;
    public getCurrentEventLevel(body: GetCurrentEventLevelRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GetCurrentEventLevelResponse>>;
    public getCurrentEventLevel(body: GetCurrentEventLevelRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GetCurrentEventLevelResponse>>;
    public getCurrentEventLevel(body: GetCurrentEventLevelRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling getCurrentEventLevel.');
        }
        ...
        return this.httpClient.request<GetCurrentEventLevelResponse>('post',`${this.basePath}/Event/getCurrentEventLevel`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
