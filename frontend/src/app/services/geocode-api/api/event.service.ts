...
export class EventService {
    ...
    /**
     * Gets the User&#x27;s blocks for a Blockly Event
     * Gets the User&#x27;s blocks for a Blockly Event
     * @param body Request to get the User&#x27;s blocks for a Blockly Event
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getBlocks(body: GetBlocksRequest, observe?: 'body', reportProgress?: boolean): Observable<GetBlocksResponse>;
    public getBlocks(body: GetBlocksRequest, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GetBlocksResponse>>;
    public getBlocks(body: GetBlocksRequest, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GetBlocksResponse>>;
    public getBlocks(body: GetBlocksRequest, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling getBlocks.');
        }
        ...
        return this.httpClient.request<GetBlocksResponse>('post',`${this.basePath}/Event/getBlocks`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
