...
public class UpdateAvailabilityRequest   {
  ...
  public UpdateAvailabilityRequest description(String description) {
  ...
  public UpdateAvailabilityRequest location(String location) {
  ...
  public UpdateAvailabilityRequest hints(List<String> hints) {
    this.hints = hints;
    return this;
  }

  public UpdateAvailabilityRequest addHintsItem(String hintsItem) {
  ...
  public UpdateAvailabilityRequest difficulty(DifficultyEnum difficulty) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.description, updateAvailabilityRequest.description) &&
        Objects.equals(this.location, updateAvailabilityRequest.location) &&
        Objects.equals(this.hints, updateAvailabilityRequest.hints) &&
        Objects.equals(this.difficulty, updateAvailabilityRequest.difficulty);
  }
