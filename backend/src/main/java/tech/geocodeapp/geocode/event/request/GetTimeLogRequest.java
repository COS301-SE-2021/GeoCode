 ...
 */
@Validated
public class GetTimeLogRequest {
    ...
    /**
     * The unique id of the geoCode to get
     */
    @JsonProperty( "geoCodeID" )
    @NotNull( message = "GetTimeLogRequest geoCodeID attribute cannot be null." )
    private UUID geoCodeID;

    /**
     * Default Constructor
     */
    public GetTimeLogRequest() {
     ...
     * @param geoCodeID The unique id of the geoCode to get
     */
    public GetTimeLogRequest( UUID eventID, UUID userID, UUID geoCodeID ) {
     ...
     */
    public GetTimeLogRequest eventID( UUID eventID ) {
     ...
     */
    public GetTimeLogRequest userID( UUID userID ) {
     ...
     */
    public GetTimeLogRequest geoCodeID( UUID geoCodeID ) {
    ...
    public boolean equals( java.lang.Object obj ) {
        ...
        GetTimeLogRequest getTimeLogRequest = ( GetTimeLogRequest ) obj;
        return Objects.equals( this.eventID, getTimeLogRequest.eventID ) &&
                Objects.equals( this.userID, getTimeLogRequest.userID ) &&
                Objects.equals( this.geoCodeID, getTimeLogRequest.geoCodeID );
    }
    ...
    public int hashCode() {
        ...
        return Objects.hash( eventID, userID, geoCodeID );
    }
