...
public class GetAllTimeTrialsResponse {
    ...
    /**
     * Sets a single TimeTrial inside of the timeTrials attribute to the specified value
     *
     * @param eventsItem the value the attribute should be set to
     *
     * @return the stored timeTrials attribute
     */
    public GetAllTimeTrialsResponse addEventsItem( TimeTrial eventsItem ) {
     ...
     */
    @Valid
    public List< TimeTrial > getEvents() {
     ...
     * @param timeTrials the value the attribute should be set to
     */
    public void setEvents( List< TimeTrial > timeTrials ) {
