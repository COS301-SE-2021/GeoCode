...
/**
 * GetCollectablesInGeoCodeByQRCodeResponse used to access the attributes received to create the response
 * that returns the GeoCode with the specified QR Code
 */
@Validated
public class GetCollectablesInGeoCodeByQRCodeResponse {
     ...
     * Default constructor
     */
    public GetCollectablesInGeoCodeByQRCodeResponse() {
     ...
     */
    public GetCollectablesInGeoCodeByQRCodeResponse( ArrayList< Collectable > storedCollectable ) {
     ...
     */
    public GetCollectablesInGeoCodeByQRCodeResponse storedCollectable( ArrayList< Collectable > storedCollectable ) {
    ...
    public boolean equals( java.lang.Object obj ) {
        ...
        return Objects.equals( this.storedCollectable, ( ( GetCollectablesInGeoCodeByQRCodeResponse ) obj ).storedCollectable );
    }
    ...
    public String toString() {
        ...
        return "class GetCollectablesInGeoCodeByQRCodeResponse {\n" +
